...
@pytest.mark.parametrize(
    ...
    [
        ...
        (None, 100000, 0, 1.0, 3, 10, 100, 100, True),
        (None, 10, "hehe", 1.0, 3, 10, 100, 100, True),
        (None, 10, -1.0, 1.0, 3, 10, 100, 100, True),
        (None, 10, 1.5, 1.0, 3, 10, 100, 100, True),
        (None, 10, 0, "hehe", 3, 10, 100, 100, True),
        (None, 10, 0, 1.5, 3, 10, 100, 100, True),
        (None, 100, -3.0, 0.99, 3, 30, 100, None, True),
        (None, 100, 0.01, 1, 3, 30, 100, None, True),
        (None, 100, 0.01, -4.5, 3, 30, 100, None, True),
        (None, 100, 0.01, 5.5, 3, 30, 100, None, True),
        (None, 100, 0.99, 0.01, 3, 30, 100, None, True),
        (None, 100, 0.01, 0.99, 3.0, 30, 100, None, True),
        (None, 100, 0.01, 0.99, -2, 30, 100, None, True),
        (None, 100, 0.01, 0.99, 30, 30, 100, None, True),
        (None, 100, 0.01, 0.99, 3, 30.0, 100, None, True),
        (None, 100, 0.01, 0.99, 3, -2, 100, None, True),
        (None, 100, 0.01, 0.99, 3, 500, 100, None, True),
        (None, 100, 0.01, 0.99, 3, 30, 100.0, None, True),
        (None, 100, 0.01, 0.99, 3, 30, -100, None, True),
        (None, 100, 0.01, 0.99, 3, 30, 10000000000, None, True),
        (None, 100, 0.01, 0.99, 3, 30, 100, 234.5, True),
        (None, 100, 0.01, 0.99, 3, 30, 100, -5, True),
        (None, 100, 0.01, 0.99, 3, 30, 100, None, 4.0),
